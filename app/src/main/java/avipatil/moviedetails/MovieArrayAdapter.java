...
/**
 * Created by avipatil on 3/10/2017.
 */
...
public class MovieArrayAdapter extends ArrayAdapter {
    ...
    public MovieArrayAdapter(Context context, int resource, List<MovieDetails> movieDetailses) {
        super(context, resource, movieDetailses);
        this.context=context;
        this.movieDetailsList=movieDetailses;
